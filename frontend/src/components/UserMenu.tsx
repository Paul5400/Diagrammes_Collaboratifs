...
export function UserMenu({ name = 'John Doe', plan = 'Free Plan', initials = 'JD', avatarUrl }: UserMenuProps) {
  return (
    <Link
      href="/profile"
    ...
    >
      <div className="text-right">
        <div className="text-[13px] font-medium group-hover:text-[var(--accent-primary)] transition-colors">{name}</div>
